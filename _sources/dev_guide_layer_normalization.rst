...
:math:`\gamma`                                              DNNL_ARG_SCALE                                                                                                                                                     Input          
:math:`\beta`                                               DNNL_ARG_SHIFT                                                                                                                                                     Input          
mean ( :math:`\mu` )                                        DNNL_ARG_MEAN                                                                                                                                                      Input/Output   
variance* ( :math:`\sigma` )                                DNNL_ARG_VARIANCE                                                                                                                                                  Input/Output   
:math:`\dst`                                                DNNL_ARG_DST                                                                                                                                                       Output         
:math:`\diffdst`                                            DNNL_ARG_DIFF_DST                                                                                                                                                  Input          
:math:`\diffsrc`                                            DNNL_ARG_DIFF_SRC                                                                                                                                                  Output         
:math:`\diffgamma`                                          DNNL_ARG_DIFF_SCALE                                                                                                                                                Output         
:math:`\diffbeta`                                           DNNL_ARG_DIFF_SHIFT                                                                                                                                                Output         
:math:`src scale`                                           DNNL_ARG_ATTR_SCALES | DNNL_ARG_SRC                                                                                                                                Input          
:math:`dst scale`                                           DNNL_ARG_ATTR_SCALES | DNNL_ARG_DST                                                                                                                                Input          
...
See :ref:`Examples and Tutorials <doxid-dev_guide_examples>` page for a complete list. Layer normalization examples are listed in the :ref:`Normalization Primitives <doxid-dev_guide_examples_1examples_normalization>` section.
